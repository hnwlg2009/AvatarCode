...
### v0.3.0 (规划中 - 预计2026年Q2)
**主题**: 跨平台支持与自动更新

#### 核心功能
- [ ] **macOS支持**: DMG/ZIP格式，Apple Silicon兼容
- [ ] **Linux支持**: AppImage/DEB格式，主流发行版兼容
- [ ] **自动更新**: 基于electron-updater，GitHub Releases
- [ ] **代码签名**: Windows EV证书，macOS公证
- [ ] **安装程序**: Windows NSIS，macOS DMG
- [ ] **多语言扩展**: 新增日语、韩语、法语、德语、西班牙语

#### 详细规划
详见: [ROADMAP_V0.3.0.md](ROADMAP_V0.3.0.md)
